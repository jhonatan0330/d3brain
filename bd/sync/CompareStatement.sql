WbDataDiff -referenceProfile="New"
           ...
           procesotransicionautomatica_ptap, producto_prop, productoinventario_pinp,  productoinventariodescuento_pidp, puesto_puep, tarifa_tarp, trazabilidadproductoinventario_tpip, turno_turp,
           usuario_usrp, usuarioautenticacion_uaup, usuariorol_erlp, usuariorolproducto_urpp , usuariosesion_ussp
