...
INSERT INTO documentoplantilla_dplp(cdpl_llave,  cdpl_nombre,  cdpl_imagen, cdpl_codigo, cdpl_objetivo)
	VALUES('DPL_REP',  'INFORMES GENERALES', 'http://colombiansofture.com/imagenes/modulo.png',  'DOCUMENTACION', 'Permite imprimir los reportes que muestran la documentación del sistema');
...
INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave,  cdpc_plantilla,  ndpc_orden, cdpc_nombre,  cdpc_codigo,  cdpc_formato,  cdpc_objetivo)
	VALUES('ce1318a457124f0fba0894f171ba675f',  'DPL_REP', 1,  'PLANTILLA',  'PLANTILLA',  'G',  'Permite seleccionar una plantilla para filtrar la documentación');
INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave,  cdpc_plantilla,  ndpc_orden, cdpc_nombre,  cdpc_codigo,  cdpc_formato,  cdpc_objetivo)
	VALUES('671e153b061b40b48e69cb21c49b1357',  'DPL_REP', 2,  'PROCESO',  'PROCESO',  'G',  'Seleccionar un proceso para conocer la documentación del proceso');
INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave,  cdpc_plantilla,  ndpc_orden, cdpc_nombre,  cdpc_codigo,  cdpc_formato,  cdpc_objetivo)
	VALUES('671e153b061b40b48e69cb21c49b1358',  'DPL_REP', 3,  'CAMBIO',  'CAMBIO',  'G',  'Seleccionar un cambio para filtrar la documentacion');
INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave,  cdpc_plantilla,  ndpc_orden, cdpc_nombre,  cdpc_codigo,  cdpc_formato,  cdpc_objetivo)
	VALUES('671e153b061b40b48e69cb21c49b1359',  'DPL_REP', 4,  'ROL',  'ROL',  'G',  'Seleccionar un rol para filtrar la documentacion');

INSERT INTO propiedad_ppdp(cppd_llave,  cppd_campo,  cppd_valor, cppd_propiedadvalor,  dppd_fechadefinicion, cppd_motivo,  cppd_cambiocreacion,  cppd_tipo)VALUES('8fa382ef18874d3fb225a9ca0ef1d791',  'ce1318a457124f0fba0894f171ba675f',  'PLANTILLAS', 'PROP_08', now(), 'Permite escoger entre las plantillas activas',  'SC_REP', 'C');
INSERT INTO propiedad_ppdp(cppd_llave,  cppd_campo,  cppd_valor, cppd_propiedadvalor,  dppd_fechadefinicion, cppd_motivo,  cppd_cambiocreacion,  cppd_tipo)VALUES('b592559b6aa0426b8e5dd58a9009d364',  '671e153b061b40b48e69cb21c49b1357',  'PROCESO', 'PROP_08',  now(), 'Permite escoger entre los procesos activos del sistema',  'SC_REP', 'C');
INSERT INTO propiedad_ppdp(cppd_llave,  cppd_campo,  cppd_valor, cppd_propiedadvalor,  dppd_fechadefinicion, cppd_motivo,  cppd_cambiocreacion,  cppd_tipo)VALUES('b592559b6aa0426b8e5dd58a9009d365',  '671e153b061b40b48e69cb21c49b1358',  'CAMBIO', 'PROP_08',  now(), 'Permite escoger entre los cambios activos',  'SC_REP', 'C');
INSERT INTO propiedad_ppdp(cppd_llave,  cppd_campo,  cppd_valor, cppd_propiedadvalor,  dppd_fechadefinicion, cppd_motivo,  cppd_cambiocreacion,  cppd_tipo)VALUES('b592559b6aa0426b8e5dd58a9009d366',  '671e153b061b40b48e69cb21c49b1359',  'ROLES', 'PROP_08',  now(), 'Permite escoger entre los cambios activos',  'SC_REP', 'C');
INSERT INTO propiedad_ppdp(cppd_llave,  cppd_campo,  cppd_valor, cppd_texto,  cppd_propiedadvalor,  dppd_fechadefinicion,  cppd_motivo,  cppd_cambiocreacion, cppd_tipo)VALUES('c8144ca461484756bac2a1fc4dea58e7',  '55ca8eb82203432a9ae0ddd3b2485d87',  'a8368eef8d2e4383b8d52a1bcf9c1e2e',  'ENCABEZADO CARTA',  'PROP_70',  now(),  'El reporte tendra el encabezado general del sistema',  'SC_REP',  'E');

INSERT INTO reportebase_rpbp(crpb_llave,  crpb_nombre,  crpb_plantilla, crpb_codigo,  nrpb_version,  crpb_descripcion)
	VALUES('55ca8eb82203432a9ae0ddd3b2485d87',  'REQUERIMIENTOS DEL SISTEMA',  'DPL_REP',  'CHECK SW42',  1,  'Muestra los requerimientos del sistema');
...
VALUES('55ca8eb82203432a9ae0ddd3b2485d87', '55ca8eb82203432a9ae0ddd3b2485d87', 'PROP_138',  now(),  'Esquema del reporte',  'SC_REP',  'E',
...
INSERT INTO reportebase_rpbp(crpb_llave,  crpb_nombre,  crpb_plantilla, crpb_codigo,  nrpb_version,  crpb_descripcion, brpb_soloexistente)
	VALUES('a8368eef8d2e4383b8d52a1bcf9c1e2e',  'ENCABEZADO CARTA',  'DPL_REP',  'ENC_LETTER',  1,  'Servir como plantilla para todos los reportes tamano carta', true);
	
INSERT INTO propiedad_ppdp(cppd_llave, cppd_campo, cppd_propiedadvalor,  dppd_fechadefinicion,  cppd_motivo,  cppd_cambiocreacion, cppd_tipo, cppd_valor)
VALUES('a8368eef8d2e4383b8d52a1bcf9c1e2e', 'a8368eef8d2e4383b8d52a1bcf9c1e2e', 'PROP_138',  now(),  'Esquema del reporte',  'SC_REP',  'E',
'<?xml version="1.0" encoding="UTF-8"?>
...
INSERT INTO reportebase_rpbp(crpb_llave,  crpb_nombre,  crpb_plantilla, crpb_codigo,  nrpb_version,  crpb_descripcion, brpb_soloexistente)
	VALUES('a8368eef8d2e4383b8d52a1bcf9c1e23',  'PIE DE PAGINA CARTA', 'DPL_REP',  'FOOT_LETTER',  1,  'Sirve como pie de pagina para los reportes Carta', true);

INSERT INTO propiedad_ppdp(cppd_llave, cppd_campo, cppd_propiedadvalor,  dppd_fechadefinicion,  cppd_motivo,  cppd_cambiocreacion, cppd_tipo, cppd_valor)
VALUES('a8368eef8d2e4383b8d52a1bcf9c1e23', 'a8368eef8d2e4383b8d52a1bcf9c1e23', 'PROP_138',  now(),  'Esquema del reporte',  'SC_REP',  'E',
'<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Jaspersoft Studio version 6.8.0.final using JasperReports Library version 6.8.0-2ed8dfabb690ff337a5797129f2cd92902b0c87b  -->
...
INSERT INTO reportebase_rpbp(crpb_llave,  crpb_nombre, crpb_plantilla,  crpb_codigo,  nrpb_version,  crpb_descripcion, brpb_soloexistente)
VALUES('DPL_REP_PORTRAIT',  'ENCABEZADO CARTA HORIZONTAL',  'DPL_REP',  'ENC_LETTER_P',  1,  'Servir como plantilla para todos los reportes tamano carta orientacion vertical', true);  

INSERT INTO propiedad_ppdp(cppd_llave, cppd_campo, cppd_propiedadvalor,  dppd_fechadefinicion,  cppd_motivo,  cppd_cambiocreacion, cppd_tipo, cppd_valor)
VALUES('DPL_REP_PORTRAIT', 'DPL_REP_PORTRAIT', 'PROP_138',  now(),  'Esquema del reporte',  'SC_REP',  'E',
  '<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Jaspersoft Studio version 6.8.0.final using JasperReports Library version 6.8.0-2ed8dfabb690ff337a5797129f2cd92902b0c87b  -->
...
crpb_llave =  $P{P_REPORTE}]]>
	...
	<pageHeader>
		<band height="48">
			...
			<textField evaluationTime="Report" pattern="yyyy.MM.dd hh:mm:ss aaa" isBlankWhenNull="true">
				<reportElement x="500" y="8" width="153" height="12" uuid="ac7bf66e-6e91-40aa-9fbe-bc9473c1cefa"/>
				<box leftPadding="3" rightPadding="3">
					<pen lineWidth="0.5"/>
					<topPen lineWidth="0.5" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.5" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="500" y="28" width="153" height="12" uuid="98fafd38-9296-40df-b3f0-922628758833"/>
				<box>
					<pen lineWidth="0.5"/>
					<topPen lineWidth="0.5"/>
					<leftPen lineWidth="0.5"/>
...
INSERT INTO reportebase_rpbp(crpb_llave,  crpb_nombre, crpb_plantilla,  crpb_codigo,  nrpb_version,  crpb_descripcion, brpb_soloexistente)
VALUES('DPL_ENC_EXCEL',  'ENCABEZADO EXCEL',  'DPL_REP',  'ENC_EXCEL',  1,  'Servir como plantilla para todos los reportes de excel', true);

INSERT INTO propiedad_ppdp(cppd_llave, cppd_campo, cppd_propiedadvalor,  dppd_fechadefinicion,  cppd_motivo,  cppd_cambiocreacion, cppd_tipo, cppd_valor)
VALUES('DPL_ENC_EXCEL', 'DPL_ENC_EXCEL', 'PROP_138',  now(),  'Esquema del reporte',  'SC_REP',  'E',
  '<?xml version="1.0" encoding="UTF-8"?>
