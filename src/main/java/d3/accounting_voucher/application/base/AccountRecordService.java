package d3.accounting_voucher.application.base;
...
import d3.accounting_voucher.infrastructure.AccountRecordMapper;
...
public class AccountRecordService {
	...
	public AccountRecordService(@Lazy AccountRecordMapper mapper) {
		this.mapper = mapper;
	}
