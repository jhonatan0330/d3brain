...
public class UsuarioRolSvc extends BasicSvc<UsuarioRolDTO, UsuarioRolFilterDTO> {
	...
	public UsuarioRolSvc(@Lazy UsuarioRolMapper usuarioRolMapper,
	...
	public UsuarioRolDTO actualizar(UsuarioRolDTO dto) throws ServerException {
		throw new ServerException("Lo que se debe actualizar es el documento");
	}

	@Override
	@Transactional(value = "transactionManager", rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public UsuarioRolDTO inactivar(UsuarioRolDTO dto) throws ServerException {
	...
	@Override
	@Transactional(value = "transactionManager", rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public UsuarioRolDTO guardar(UsuarioRolDTO dto) throws ServerException {
		dto.setFechaInicial(new Date());
		dto = super.guardar(dto);
		autenticacionService.crearAutenticacion(dto.getUsuario());
		cacheService.clearUserRoleMap();
		return dto;
	}
