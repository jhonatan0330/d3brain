...
public class ProductoInventarioSvc extends BasicSvc<ProductoInventarioDTO, ProductoInventarioFilterDTO> {
	...
	public ProductoInventarioDTO actualizar(ProductoInventarioDTO dto) throws ServerException {
	...
	@Override
	public ProductoInventarioDTO guardar(ProductoInventarioDTO dto) throws ServerException {
