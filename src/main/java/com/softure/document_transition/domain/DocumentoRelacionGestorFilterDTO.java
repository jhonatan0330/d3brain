...
public class DocumentoRelacionGestorFilterDTO extends BasicFilterDTO {
	...
	public void setCierreMin(Date cierreMin) {
		this.cierreMin = cierreMin;
	}

	public Date getCierreMin() {
		return cierreMin;
	}

	public void setCierreMax(Date cierreMax) {
		this.cierreMax = cierreMax;
	}

	public Date getCierreMax() {
		return cierreMax;
	}
