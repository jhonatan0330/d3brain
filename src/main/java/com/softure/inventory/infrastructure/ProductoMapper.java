...
public interface ProductoMapper extends IBasicMapper<ProductoDTO, ProductoFilterDTO>{
	...
	List<ProductoDTO> listarProductoFuncion(@Param("funcion")String funcion, @Param("documento")String documento, @Param("filtro") String filtro, @Param("token") String token,@Param("parametros") List<PedidoVentaCaracteristicaDTO> parametros);
