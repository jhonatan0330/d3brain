...
public class MassiveItemController {
	...
	public MassiveItemController(@Lazy MassiveCRUDItemService cargaMasivaItemService) {
		this.cargaMasivaItemService = cargaMasivaItemService;
	}

	@GetMapping("")
	public List<MasivaItemRequest> find(@RequestHeader(name = "Authorization") String token, String cargaFilter,
			String documentoFilter, Date fechaSerializacionMin, Date fechaSerializacionMax, Date fechaSincronizacionMin,
			Date fechaSincronizacionMax, String modeloFilter, String nombreFilter, String progresoFilter,
			@RequestParam(defaultValue = "A") String state, @RequestParam(defaultValue = "0") int page,
	...
	@GetMapping("/get")
	public MasivaItemRequest get(@RequestHeader(name = "Authorization") String token, String cargaFilter,
			String documentoFilter, Date fechaSerializacionMin, Date fechaSerializacionMax, Date fechaSincronizacionMin,
			Date fechaSincronizacionMax, String modeloFilter, String nombreFilter, String progresoFilter,
	...
	@GetMapping("/{id}")
	public MasivaItemRequest findById(@RequestHeader(name = "Authorization") String token, @PathVariable String id)
	...
	public SharedIdResponse save(@RequestHeader(name = "Authorization") String token,
		...
		return null;
		// return new SharedIdResponse(cargaMasivaItemService.save(token,
		// body).getCargaMasivaItemId());
	}
	...
	public SharedIdResponse update(@RequestHeader(name = "Authorization") String token,
		...
		// return new SharedIdResponse(cargaMasivaItemService.update(token, body,
		// id).getCargaMasivaItemId());
		return null;
	}

	@PutMapping("/activate/{id}")
	@Transactional(value = "transactionManager", rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void activate(@RequestHeader(name = "Authorization") String token, @PathVariable String id)
			throws ServerException {
	...
	@Transactional(value = "transactionManager", rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void inactivate(@RequestHeader(name = "Authorization") String token, @PathVariable String id)
			throws ServerException {
