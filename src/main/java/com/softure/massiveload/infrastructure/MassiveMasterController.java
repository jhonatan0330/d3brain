...
public class MassiveMasterController {
	...
	public MassiveMasterController(@Lazy MassiveCRUDMasterService cargaMasivaService) {
		this.cargaMasivaService = cargaMasivaService;
	}

	@GetMapping("")
	public List<MassiveMasterRequest> find(@RequestHeader(name = "Authorization") String token, String archivoFilter,
			Date fechaMin, Date fechaMax, String mensajeFilter, String plantillaFilter, String progresoFilter,
			String usuarioFilter, @RequestParam(defaultValue = "A") String state,
	...
	@GetMapping("/get")
	public MassiveMasterRequest get(@RequestHeader(name = "Authorization") String token, String archivoFilter,
			Date fechaMin, Date fechaMax, String mensajeFilter, String plantillaFilter, String progresoFilter,
			String usuarioFilter, @RequestParam(defaultValue = "A") String state) throws ServerException {
	...
	@GetMapping("/{id}")
	public MassiveMasterRequest findById(@RequestHeader(name = "Authorization") String token, @PathVariable String id)
			throws ServerException {
	...
	public SharedIdResponse save(@RequestHeader(name = "Authorization") String token,
		...
		// return new
		// SharedIdResponse(cargaMasivaService.save(body).getCargaMasivaId());
		return null;
	}
	...
	public SharedIdResponse update(@RequestHeader(name = "Authorization") String token,
		...
		// return new SharedIdResponse(cargaMasivaService.update(token, body,
		// id).getCargaMasivaId());
		return null;
	}
