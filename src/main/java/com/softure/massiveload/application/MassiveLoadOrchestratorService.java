...
public class MassiveLoadOrchestratorService {
	...
	private final com.softure.document_execution.application.PedidoVentaSvc pedidoService;
	...
	public MassiveLoadOrchestratorService(@Lazy MassiveFileParserService parserService,
			...
			@Lazy com.softure.document_execution.application.PedidoVentaSvc pedidoService) {
