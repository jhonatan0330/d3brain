...
public interface PropertyCacheMapper{
	...
	List<PropiedadDTO> obtenerEspecialFullPermisosSimplificandoBD(@Param("plantillas") List<DocumentoPlantillaDTO> plantillas,@Param("profile") String pProfile, @Param("user") String pUser);
