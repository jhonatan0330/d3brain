...
public class Propiedades {
	...
	public static String instrucciones(String formato){
		...
		switch(formato) {
			...
			case API_CODE_ESPECIAL : {ruleProperty = "Se encarga de reemplazar un valor en el template.\n\nColoca en el campo TEXTO de la propiedad el codigo que va a reeemplazar y en el VALOR coloca el texto que quieres que se modifique.\n\nSE crea un TRUCO para la fecha actual: el codigo debe empezar por E_FECHA_XXXXXX y en el VALOR de la propiedad colocas el formato tipo fecha\nAhora si quieres sumar valores debes seguir estas instrucciones: al final coloca el tiempo a sumar en parentesis dentro un signo el numero y una letra del tiempo, por el momento solo suma Dias ejemplo: E_FECHA_XXXX(+15D)\n\nE_ID = llave id del documento\nE_CODE = codigo del documento\nE_CODE_MODIFICATOR = codigo del documento modificador";break;}
			case API_CODE_MODIFICADOR : {ruleProperty = "Se encarga de reemplazar un valor en el template, tomando como base el documento que genero la accion (Solo en transiciones).\n\nEn el template debes tener la estructura => {{M_XXXXXXX}} , donde XXXXXX es el codigo del campo, el valor auxiliar corresponde a formatos de fecha";break;}
			case API_ITERATION_ONE_EXECUTION : {ruleProperty = "En una transicion que va despues de un iterador, se va a ejecutar un api por cada documento SI Seleccionas esta propiedad SOLO SE VA A EJECUTAR UN API";break;}
			...
			case PLANTILLA_HISTORIAL_ACTIVO : {ruleProperty =  " Al momento de consultar el historial por defecto el muestra solo la opcion de documentos, con esta porpiedad se pueden activar las otras opciones de forma inicial, para lograrlo debes usar numeros de la siguiente forma:\n\n1-Documentos\n2-Asignaciones\n3-Mensajes\n4-Inventario\n5-Automaticas\n6-Reportes\n7-API";break;}
