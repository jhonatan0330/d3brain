COMMENT ON TABLE usuario_usrp IS '2018-07-20';

DROP FUNCTION casos_prueba();

ALTER TABLE cuentapermisousuario_cpup
	DROP COLUMN ccpu_old;
...
BEGIN 
    ...
    SELECT cppr_descripcion INTO plantilla_campo_descripcion FROM plantillaparametro_pprp where cppr_plantilla = plantilla and cppr_estado = ''A'';
