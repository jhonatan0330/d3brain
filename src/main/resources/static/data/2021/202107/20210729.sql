...
BEGIN 
    ...
    ELSE
		SELECT cppd_valor INTO plantilla_campo_descripcion_nivel2 FROM propiedad_ppdp where cppd_campo = plantilla and cppd_estado = 'A' and cppd_propiedadvalor = 'PROP_45';
