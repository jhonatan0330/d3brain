COMMENT ON TABLE usuario_usrp IS '2021-10-02';
...
insert into propiedad_ppdp (cppd_llave,cppd_campo,cppd_valor,cppd_texto,cppd_estado,cppd_propiedadvalor,dppd_fechadefinicion,dppd_fechaimplementacion,cppd_motivo,cppd_cambiocreacion,cppd_cambioeliminacion,cppd_tipo,cppd_rol,dppd_fechainicial,dppd_fechafinal,cppd_usuario,cppd_bloqueo) values ('b3c95a486d1f40acbc317dbb668a4d1f','57c7788e671b4bc192fe2700ad71378d','15','00:00:07:00:00','A','PROP_185',TIMESTAMP '2021-10-02 07:11:35.730000 -0500',TIMESTAMP '2021-10-02 07:11:35.727000 -0500','Pasar a tabla historico','80b94072128c4720a2c68363555314e4',NULL,'L',NULL,TIMESTAMP '2021-10-02 07:11:35.722000 -0500',NULL,NULL,NULL);
insert into propiedad_ppdp (cppd_llave,cppd_campo,cppd_valor,cppd_texto,cppd_estado,cppd_propiedadvalor,dppd_fechadefinicion,dppd_fechaimplementacion,cppd_motivo,cppd_cambiocreacion,cppd_cambioeliminacion,cppd_tipo,cppd_rol,dppd_fechainicial,dppd_fechafinal,cppd_usuario,cppd_bloqueo) values ('607904404ea94ef89e486945563bb843','147cac472c604deaa943c7a6cb5d3893','1',NULL,'A','PROP_134',TIMESTAMP '2021-10-02 07:11:49.687000 -0500',TIMESTAMP '2021-10-02 07:11:49.685000 -0500',NULL,'80b94072128c4720a2c68363555314e4',NULL,'C',NULL,NULL,NULL,NULL,NULL);
insert into propiedad_ppdp (cppd_llave,cppd_campo,cppd_valor,cppd_texto,cppd_estado,cppd_propiedadvalor,dppd_fechadefinicion,dppd_fechaimplementacion,cppd_motivo,cppd_cambiocreacion,cppd_cambioeliminacion,cppd_tipo,cppd_rol,dppd_fechainicial,dppd_fechafinal,cppd_usuario,cppd_bloqueo) values ('0ef9a69c966a488681689637ba18b2da','d1c9f83727ea43f2ad97d90b0f4eb0f8','1',NULL,'A','PROP_32',TIMESTAMP '2021-10-02 07:32:49.426000 -0500',TIMESTAMP '2021-10-02 07:32:49.423000 -0500',NULL,'80b94072128c4720a2c68363555314e4',NULL,'C',NULL,NULL,NULL,NULL,NULL);
...
end;','00:00:01:00:00','A','PROP_189',TIMESTAMP '2021-10-02 07:33:12.388000 -0500',TIMESTAMP '2021-10-02 07:33:12.388000 -0500','Consulta los usuarios de soporte','80b94072128c4720a2c68363555314e4',NULL,'L',NULL,TIMESTAMP '2021-10-02 04:00:00.000000 -0500',NULL,NULL,NULL);
insert into propiedad_ppdp (cppd_llave,cppd_campo,cppd_valor,cppd_texto,cppd_estado,cppd_propiedadvalor,dppd_fechadefinicion,dppd_fechaimplementacion,cppd_motivo,cppd_cambiocreacion,cppd_cambioeliminacion,cppd_tipo,cppd_rol,dppd_fechainicial,dppd_fechafinal,cppd_usuario,cppd_bloqueo) values ('99edc409f74d43418f18dfbc9497eccc','d1c9f83727ea43f2ad97d90b0f4eb0f8','1',NULL,'A','PROP_134',TIMESTAMP '2021-10-02 08:28:42.609000 -0500',TIMESTAMP '2021-10-02 08:28:42.606000 -0500',NULL,'80b94072128c4720a2c68363555314e4',NULL,'C',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave, cdpc_plantilla, ndpc_orden, cdpc_nombre, cdpc_codigo, cdpc_formato, cdpc_objetivo)
    select 'ADMINISTRADOR-ID', 'ADMINISTRADOR',  1, 'ID', 'ID', 'T', 'Contiene el numero de cedula del administrador'
    WHERE NOT EXISTS (SELECT 1 FROM documentoplantillacaracteristica_dpcp WHERE cdpc_llave ='ADMINISTRADOR-ID');
...
INSERT INTO propiedad_ppdp (cppd_llave, cppd_tipo, cppd_propiedadvalor, cppd_campo, cppd_valor, cppd_motivo, dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion)
	SELECT 'ADMINISTRADOR-ID_2', 'C', 'PROP_105', 'ADMINISTRADOR-ID', '1', 'Se tiene permisos para modificar el campo', now(), now(), '80b94072128c4720a2c68363555314e4'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='ADMINISTRADOR-ID_2');

INSERT INTO documentoplantillacaracteristica_dpcp(cdpc_llave, cdpc_plantilla, ndpc_orden, cdpc_nombre, cdpc_codigo, cdpc_formato, cdpc_objetivo)
    select 'ADMINISTRADOR-NM', 'ADMINISTRADOR', 2, 'NOMBRE', 'NOMBRE', 'T', 'Contiene el nombre completo del administrador'
     WHERE NOT EXISTS (SELECT 1 FROM documentoplantillacaracteristica_dpcp WHERE cdpc_llave = 'ADMINISTRADOR-NM');
    
INSERT INTO propiedad_ppdp (cppd_llave, cppd_tipo, cppd_propiedadvalor, cppd_campo, cppd_valor, cppd_motivo, dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion)
	SELECT 'ADMINISTRADOR-NM_2', 'C', 'PROP_105', 'ADMINISTRADOR-NM', '1', 'Se tiene permisos para modificar el campo', now(), now(), '80b94072128c4720a2c68363555314e4'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='ADMINISTRADOR-NM_2');
...
INSERT INTO propiedad_ppdp (cppd_llave, cppd_propiedadvalor, cppd_campo, cppd_valor, cppd_texto,  dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion, cppd_tipo) 
	select 'DESC_ADMINISTRADOR' , 'PROP_44', 'ADMINISTRADOR', 'ADMINISTRADOR-NM', 'NOMBRE', now(), now(), '80b94072128c4720a2c68363555314e4', 'L'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='DESC_ADMINISTRADOR');

INSERT INTO propiedad_ppdp (cppd_llave, cppd_propiedadvalor, cppd_campo, cppd_valor, cppd_texto, dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion, cppd_tipo)
	SELECT 'CONSE_ADMINISTRADOR' , 'PROP_48', 'ADMINISTRADOR', 'ADMINISTRADOR-ID', 'ID', now(), now(), '80b94072128c4720a2c68363555314e4', 'L'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='CONSE_ADMINISTRADOR');

INSERT INTO propiedad_ppdp (cppd_llave, cppd_propiedadvalor, cppd_campo, cppd_valor, cppd_texto, dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion, cppd_tipo)
	select 'ORDE_ADMINISTRADOR' , 'PROP_51', 'ADMINISTRADOR', 'N', 'NOMBRE', now(), now(), '80b94072128c4720a2c68363555314e4', 'L'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='ORDE_ADMINISTRADOR');
...
INSERT INTO propiedad_ppdp (cppd_llave, cppd_propiedadvalor, cppd_campo, cppd_valor, dppd_fechadefinicion, dppd_fechaimplementacion, cppd_cambiocreacion, cppd_tipo)
	select 'ADMINISTRADOR_TIPO_ROL' , 'PROP_141', 'ADMINISTRADOR', '1', now(), now(), '80b94072128c4720a2c68363555314e4', 'L'
	WHERE NOT EXISTS (SELECT 1 FROM propiedad_ppdp WHERE cppd_llave ='ADMINISTRADOR_TIPO_ROL');
	
INSERT INTO rolacceso_racp(crac_llave, brac_permisoscompletos, crac_plantilla)
    select 'ADMINISTRADOR',  true, 'ADMINISTRADOR'
...
INSERT INTO permiso_perp(cper_llave, cper_rolacceso, cper_modulo)
    ...
    WHERE NOT EXISTS (SELECT 1 FROM permiso_perp WHERE cper_llave ='ADMINISTRADOR');
...
insert into propiedad_ppdp (cppd_llave,cppd_campo,cppd_valor,cppd_texto,cppd_estado,cppd_propiedadvalor,dppd_fechadefinicion,dppd_fechaimplementacion, cppd_cambiocreacion, cppd_tipo) 
values ('49e5294011124e138dd7c661621866de','4e3014ec945e4c718dc50481220fcf80','E',NULL,'A','PROP_75',TIMESTAMP '2021-10-02 16:21:33.150000 -0500',TIMESTAMP '2021-10-02 16:21:33.125000 -0500', '80b94072128c4720a2c68363555314e4','C');
