COMMENT ON TABLE usuario_usrp IS '2021-08-12';

ALTER TABLE mensajeplantillacorreo_mplp
	ALTER COLUMN cmpl_texto TYPE character varying(120000) /* TYPE change - table: mensajeplantillacorreo_mplp original: character varying(4000) new: character varying(120000) */;

ALTER TABLE usuariorolproducto_urpp
	ADD COLUMN IF NOT EXISTS curp_modificador character varying(32);
