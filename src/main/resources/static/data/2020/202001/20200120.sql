COMMENT ON TABLE usuario_usrp IS '2020-01-20';
...
DECLARE
	...
	query text;
BEGIN
	FOR doc_record IN select cppd_llave, cppd_valor from propiedad_ppdp  where cppd_propiedadvalor  = ''PROP_41'' and cppd_estado = ''A'' LOOP
...
where cppd_propiedadvalor = 'PROP_41' and cppd_estado  = 'A';
