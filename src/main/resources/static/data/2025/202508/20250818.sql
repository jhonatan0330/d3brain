 COMMENT ON TABLE usuario_usrp IS '2025-08-18';


CREATE OR REPLACE FUNCTION public.regresar_campos(_documento character varying) RETURNS numeric
AS '
declare 
...
begin
	...
	INSERT INTO documentorelacionexpediente_dexp (cdex_llave, cdex_campomaestro, cdex_expedientedetalle, cdex_transaccionregistro, cdex_transaccioninactivo, cdex_estado, mdex_valor, cdex_documentoregistro, cdex_documentoinactivo)
	...
	INSERT INTO pedidoventadinero_pvdp(cpvd_llave, cpvd_documento, mpvd_valortotal, mpvd_saldo, cpvd_estado, dpvd_fecha, bpvd_controlarsaldo, cpvd_modificador)
	...
	INSERT INTO pedidoventaubicacion_pvup (cpvu_llave, cpvu_documento, dpvu_fecha, cpvu_ubicacion, cpvu_modificador, cpvu_estado)
		SELECT cpvu_llave, cpvu_documento, dpvu_fecha, cpvu_ubicacion, cpvu_modificador, cpvu_estado
			FROM historic.z_pvu_pedidoventaubicacion where cpvu_documento = _documento;
	...
	delete from historic.z_pvu_pedidoventaubicacion where cpvu_documento = _documento;
