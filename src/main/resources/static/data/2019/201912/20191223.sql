...
INSERT INTO documentoplantilla_dplp(cdpl_llave,  cdpl_nombre,  cdpl_consecutivo,  cdpl_estado,  cdpl_imagen,  cdpl_color,  cdpl_codigo,  cdpl_tipo,  cdpl_proceso,  cdpl_objetivo)VALUES('DPL_REP',  'INFORMES GENERALES',  'CON_REP',  'A',  'http://colombiansofture.com/imagenes/modulo.png',  NULL,  'DOCUMENTACION',  'R',  'RRHH',  'Permite imprimir los reportes que muestran la documentacion del sistema');
