...
CREATE TABLE propiedad_ppdp(
        ...
        cppd_valor character varying(120000) NOT NULL,
...
insert into pg_description (objoid, classoid, objsubid, description) select oid, 1259, 0, '2020.12.21.00' from pg_class where relname = 'usuariosesion_ussp';