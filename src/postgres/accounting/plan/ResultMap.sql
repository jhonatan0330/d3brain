...
ALTER TABLE mapa_resultados_rmp ADD drmp_creacionfecha timestamptz NOT NULL DEFAULT NOW();
ALTER TABLE mapa_resultados_rmp ADD crmp_creacionusuario varchar(32);
ALTER TABLE mapa_resultados_rmp ADD crmp_creacionusuarionombre varchar(200);
ALTER TABLE mapa_resultados_rmp ADD drmp_modificacionfecha timestamptz;
...
ALTER TABLE mapa_resultados_rmp ADD drmp_fechainicio timestamp with time zone NOT NULL ;
ALTER TABLE mapa_resultados_rmp ADD drmp_fechafin timestamp with time zone NOT NULL ;
ALTER TABLE mapa_resultados_rmp ADD crmp_periodo varchar(100) NOT NULL ;
...
ALTER TABLE mapa_resultados_rmp ADD nrmp_promedio NUMERIC(10,2) NOT NULL DEFAULT 0;
ALTER TABLE mapa_resultados_rmp ADD mrmp_saldoanterior NUMERIC(18,6) NOT NULL DEFAULT 0;
ALTER TABLE mapa_resultados_rmp ADD mrmp_saldosiguiente NUMERIC(18,6) NOT NULL DEFAULT 0;
